...
create-token:
    forge script scripts/deploy-s-oft.s.sol:DeploySepoliaOFT --rpc-url $SEPOLIA_RPC_URL --via-ir --account w2 --sender 0x442d8202c886b10d7f13ed3f0f04f311a613b144 --broadcast -vvvv
